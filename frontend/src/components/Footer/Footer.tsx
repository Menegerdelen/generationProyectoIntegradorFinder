        ...
        <div className="row g-4">
          ...
          <div className="col-lg-2 col-md-6">
            ...
            <ul className="list-unstyled">
              ...
              <li className="mb-2">
                <a href="#" className="text-muted text-decoration-none">Sobre Nosotros</a>
              </li>
              <li className="mb-2">
          ...
          <div className="col-lg-2 col-md-6">
            ...
            <ul className="list-unstyled">
              <li className="mb-2">
                <a href="#" className="text-muted text-decoration-none">Búsqueda de Empleo</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-muted text-decoration-none">Reclutamiento</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-muted text-decoration-none">Consultoría</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-muted text-decoration-none">Capacitación</a>
              </li>
              <li className="mb-2">
